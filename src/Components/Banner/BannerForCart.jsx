...
export const BannerForCart = () => {
  return (
    <div className='relative'>
        ...
        <Link to='/'>
            <h1 className='text-lg font-bold absolute top-52 left-52 text-slate-50 cursor-pointer hover:opacity-80 hover:animate-bounce'><i className="fa-solid fa-angles-left mr-2"></i>Tiếp tục mua hàng </h1>
        </Link>
    </div>
  )
}
