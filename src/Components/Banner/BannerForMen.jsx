...
import bannerImg from '/images/banner_men.png'

export const BannerForMen = () => {
  return (
    <div className='bg-gradient-to-r from-indigo-300 via-sky-200 to-purple-200 relative mt-32'>
      <img src={bannerImg} alt="Banner Image" className='w-6/12 ml-[750px] h-3/4' />
      <div className='absolute top-28  pl-48 mt-18'>
